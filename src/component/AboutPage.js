    ...
    <div id="about-container">
      <div className="ui piled segment">
        ...
        <p className="emphasized">
          <b>Equip</b> is an online marketplace for new and used durable medical
          equipment. It’s a place where transactions are <u>not</u> dictated by
          profit-driven big companies. Instead, all items are sold and bought by
          everyday individuals just like you.
        </p>
        ...
        <p>
          ...
          Additionally, plenty of items are listed for donation or for sale at a
          low cost. You can conveniently browse by location, price, pick-up or
          shipping availability, as well as items' conditions.
        </p>

        <p className="emphasized">Why Choose Equip?</p>
        <p>
